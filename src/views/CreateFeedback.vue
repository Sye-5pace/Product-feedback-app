                ...
                <div class="px-[2.625rem] py-[2.8125rem] bg-[#fff] w-full rounded-[0.625rem] h-[41.0625rem] flex flex-col gap-y-[2.5rem]">
                    ...
                    <div class="flex flex-col gap-y-6">
                        ...
                        <div class="flex flex-col gap-y-4" id="choose-category">
                            ...
                            <div class="flex flex-col gap-y-4">
                                <div class="w-[28.5rem] h-[3rem] bg-[#f7f8fd] flex items-center hover:border hover:border-[#4661e6] rounded-[0.3125rem] px-6 cursor-pointer justify-between" @click=" isCateVisible = !isCateVisible">
                                    <span class="text-[#3a4374] text-[0.9375rem]">
                                        {{ category }}
                                    </span>
                        ...
                        <div class="flex flex-col gap-y-4">
                            ...
                            <textarea  class="h-[6rem] rounded-[0.3125rem] bg-[#f7f8fd] focus:outline-none px-2 py-2" rows="4" ></textarea>
                        </div>
                    </div>
                    <div class="flex gap-4 justify-end">
                        <button class="h-[2.75rem] px-6 bg-[#3a4374] rounded-[0.625rem] flex items-center justify-center text-[#f2f4fe] font-bold">cancel</button>
                        <button class="h-[2.75rem] px-6 bg-[#AD1FEA] rounded-[0.625rem] flex items-center justify-center text-[#f2f4fe] font-bold">Add Feedback</button>
                    </div>
                </div>
            </main>
        </div>
